...
export type CreditNoteType =
  "return" | "pricing_error" | "goodwill" | "adjustment";
export type CreditNoteStatus =
  "issued" | "partially_applied" | "fully_applied" | "refunded" | "void";
...
export class CreditNoteRepository {
  ...
  private map(r: any): CreditNoteRecord {
    return {
      ...
      issuedAt:
        r.issued_at instanceof Date ? r.issued_at : new Date(r.issued_at),
  ...
  private mapApplication(r: any): CreditNoteApplicationRecord {
    return {
      ...
      amount: parseFloat(r.amount.toString()),
      appliedAt:
        r.applied_at instanceof Date ? r.applied_at : new Date(r.applied_at),

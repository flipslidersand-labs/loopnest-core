...
const crud = (
  ...
  [base]: {
    get: {
      ...
      responses: {
        "200": dataResp(`Array of ${itemName}`, {
          type: "array",
          items: ref(itemName),
        }),
      },
    ...
    post: {
      ...
      responses: {
        "201": dataResp(`Created ${itemName}`, ref(itemName)),
        ...STD_ERRORS,
      },
    },
  },
  [`${base}/{id}`]: {
    get: {
      ...
      parameters: [idParam()],
      responses: {
        "200": dataResp(itemName, ref(itemName)),
        "404": STD_ERRORS["404"],
      },
    },
    patch: {
      ...
      responses: {
        "200": dataResp(`Updated ${itemName}`, ref(itemName)),
        ...STD_ERRORS,
      },
    },
    delete: {
  ...
  paths: {
    ...
    ...crud(
      ...
      obj(
        {
          name: str(),
          type: str({ enum: ["company", "department", "division"] }),
    ...
    "/api/organizations/{id}/children": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Array of organizations", {
            type: "array",
      ...
      obj(
        {
          sku: str(),
          name: str(),
          category: str({ enum: ["laptop", "desktop", "server", "network"] }),
          unitPrice: num(),
        },
    ...
    "/api/products/sku/{sku}": {
      get: {
        ...
        parameters: [
          { name: "sku", in: "path", required: true, schema: str() },
        ],
        responses: {
          "200": dataResp("Product", ref("Product")),
          "404": STD_ERRORS["404"],
        },
      },
    },
    ...
    "/api/quotes/number/{quoteNumber}": {
      get: {
        ...
        parameters: [
          { name: "quoteNumber", in: "path", required: true, schema: str() },
        ],
        responses: {
          "200": dataResp("Quote", ref("Quote")),
          "404": STD_ERRORS["404"],
        },
      },
    },
    ...
    ...crud(
      ...
      obj(
        {
          name: str(),
          nameEn: str({ nullable: true }),
          email: str({ format: "email" }),
          organizationId: str({ format: "uuid" }),
          role: str({ enum: ["director", "manager", "senior", "sales_rep"] }),
    ...
    "/api/users/email/{email}": {
      get: {
        ...
        parameters: [
          { name: "email", in: "path", required: true, schema: str() },
        ],
        responses: {
          "200": dataResp("User", ref("User")),
          "404": STD_ERRORS["404"],
        },
      },
    },
    ...
    "/api/workflow/quotes/{id}/submit": quoteAction(
      "submit",
      "Submit a draft quote for approval",
      obj({ userId: str() }, ["userId"]),
    ),
    "/api/workflow/quotes/{id}/approve": quoteAction(
      "approve",
      "Approve a pending quote",
      obj({ userId: str(), notes: str() }, ["userId"]),
    ),
    "/api/workflow/quotes/{id}/reject": quoteAction(
      "reject",
      "Reject a pending quote",
      obj({ userId: str(), reason: str() }, ["userId", "reason"]),
    ),
    "/api/workflow/quotes/{id}/invoice": quoteAction(
      "invoice",
    ...
    "/api/workflow/quotes/{id}/status": {
      get: {
        ...
        responses: {
          "200": dataResp("Workflow status", ref("WorkflowStatus")),
          "404": STD_ERRORS["404"],
        },
      },
    },
    "/api/workflow/quotes/stage/draft": stageList("draft"),
    "/api/workflow/quotes/stage/pending-approval":
      stageList("pending_approval"),
    ...
    "/api/workflow/approvals": {
      post: {
        ...
        requestBody: body(
          obj(
            {
              quoteId: str({ format: "uuid" }),
              approverUserIds: { type: "array", items: str() },
            },
            ["quoteId", "approverUserIds"],
          ),
        ),
        responses: {
          ...
          "404": errorResp("Quote not found"),
          "409": errorResp(
            "Quote not in pending_approval, or a request already exists",
          ),
        },
      },
    },
    ...
    "/api/workflow/approvals/quote/{quoteId}/status": {
      get: {
        ...
        responses: {
          "200": dataResp("Approval status", ref("ApprovalStatus")),
          "404": STD_ERRORS["404"],
        },
      },
    },
    "/api/workflow/approvals/user/{userId}": {
      get: {
        ...
        parameters: [
          { name: "userId", in: "path", required: true, schema: str() },
        ],
        responses: {
          "200": dataResp("Array of approval requests", {
            type: "array",
    ...
    "/api/invoices/{invoiceId}/payments": {
      ...
      post: {
        ...
        parameters: [
          idParam("invoiceId", "Invoice id (UUID)"),
          idempotencyHeader,
        ],
        requestBody: body(
          obj(
            {
              amount: num({
                description: "Must be > 0 and ≤ outstanding balance",
              }),
              method: str({
                enum: ["bank_transfer", "credit_card", "cash", "offset"],
              }),
      ...
      get: {
        ...
        parameters: [
          ...
          { name: "invoiceId", in: "query", schema: str({ format: "uuid" }) },
          {
            name: "status",
            in: "query",
            schema: str({ enum: ["confirmed", "reversed"] }),
          },
          {
            name: "method",
            in: "query",
        ...
        responses: {
          "200": dataResp("Array of payments", {
            type: "array",
            items: ref("Payment"),
          }),
        },
    ...
    "/api/invoices": {
      get: {
        ...
        responses: {
          "200": dataResp("Array of invoices", {
            type: "array",
            items: { type: "object" },
          }),
        },
    ...
    "/api/invoices/{id}": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Invoice", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
    },
    ...
    "/api/members": {
      ...
      post: {
        ...
        responses: {
          "201": dataResp("Member", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    ...
    "/api/credit-notes": {
      get: {
        ...
        parameters: pageParams,
        responses: {
          "200": dataResp("Array of credit notes", {
            type: "array",
            items: { type: "object" },
          }),
        },
    ...
    "/api/credit-notes/{id}": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Credit note", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
    },
    "/api/invoices/{invoiceId}/credit-notes": {
      ...
      post: {
        ...
        requestBody: body(
          obj({ amount: num(), reason: str() }, ["amount", "reason"]),
        ),
        responses: {
          "201": dataResp("Credit note", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    ...
    "/api/tax-rates": {
      get: {
        ...
        responses: {
          "200": dataResp("Array of tax rates", {
            type: "array",
            items: { type: "object" },
          }),
        },
      ...
      post: {
        ...
        requestBody: body(
          obj({ name: str(), rate: num(), isDefault: { type: "boolean" } }, [
            "name",
            "rate",
          ]),
        ),
        responses: {
          "201": dataResp("Tax rate", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    ...
    "/api/exchange-rates": {
      get: {
        ...
        responses: {
          "200": dataResp("Array of exchange rates", {
            type: "array",
            items: { type: "object" },
          }),
        },
          ...
          obj(
            {
              currency: str(),
              rate: num(),
              effectiveDate: str({ format: "date" }),
            },
            ["currency", "rate"],
          ),
        ),
        responses: {
          "201": dataResp("Exchange rate", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    ...
    "/api/webhooks": {
      get: {
        ...
        responses: {
          "200": dataResp("Array of webhooks", {
            type: "array",
            items: { type: "object" },
          }),
        },
      ...
      post: {
        ...
        responses: {
          "201": dataResp("Webhook", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    "/api/webhooks/{id}": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Webhook", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
      put: {
        ...
        parameters: [idParam()],
        requestBody: body(
          obj({ url: str(), events: { type: "array", items: str() } }),
        ),
        responses: {
          "200": dataResp("Updated webhook", { type: "object" }),
          ...STD_ERRORS,
        },
      },
      delete: {
      ...
      get: {
        ...
        parameters: [
          { name: "webhookId", in: "query", schema: str({ format: "uuid" }) },
          {
            name: "status",
            in: "query",
            schema: str({ enum: ["success", "failed"] }),
          },
          ...pageParams,
        ],
        responses: {
          "200": dataResp("Array of deliveries", {
            type: "array",
            items: { type: "object" },
          }),
        },
    ...
    "/api/webhooks/deliveries/{id}/retry": {
      post: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Delivery result", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
    },
    ...
    "/api/audit": {
      get: {
        ...
        responses: {
          "200": dataResp("Array of audit log entries", {
            type: "array",
            items: { type: "object" },
          }),
        },
    ...
    "/api/recurring-contracts": {
      get: {
        tags: ["Recurring Contracts"],
        summary: "List recurring contracts",
        parameters: pageParams,
        responses: {
          "200": dataResp("Array of contracts", {
            type: "array",
            items: { type: "object" },
          }),
        },
      ...
      post: {
        tags: ["Recurring Contracts"],
        summary: "Create a recurring contract",
        requestBody: body(
          obj(
            {
              customerId: str({ format: "uuid" }),
            ...
            ["customerId", "billingCycle", "amount"],
          ),
        ),
        responses: {
          "201": dataResp("Contract", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    "/api/recurring-contracts/{id}": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Contract", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
      patch: {
        tags: ["Recurring Contracts"],
        summary: "Pause or resume a contract",
        parameters: [idParam()],
        requestBody: body(
          obj(
            {
              action: str({ enum: ["pause", "resume"] }),
    ...
    "/api/dunning-rules": {
      get: {
        tags: ["Dunning"],
        summary: "List dunning rules (org-scoped)",
        responses: {
          "200": dataResp("Array of rules", {
            type: "array",
            items: { type: "object" },
          }),
        },
      ...
      post: {
        ...
        requestBody: body(
          obj(
            ...
            ["organizationId", "daysOverdue", "action"],
          ),
        ),
        responses: {
          "201": dataResp("Rule", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    "/api/invoices/{invoiceId}/dunning-logs": {
      get: {
        tags: ["Dunning"],
        summary: "Dunning log for an invoice",
        parameters: [idParam("invoiceId", "Invoice id (UUID)")],
        responses: {
          "200": dataResp("Array of dunning log entries", {
            type: "array",
            items: { type: "object" },
          }),
        },
    ...
    "/api/quote-templates": {
      get: {
        ...
        parameters: pageParams,
        responses: {
          "200": dataResp("Array of templates", {
            type: "array",
            items: { type: "object" },
          }),
        },
      ...
      post: {
        ...
        responses: {
          "201": dataResp("Template", { type: "object" }),
          ...STD_ERRORS,
        },
      },
    },
    "/api/quote-templates/{id}": {
      get: {
        ...
        parameters: [idParam()],
        responses: {
          "200": dataResp("Template", { type: "object" }),
          "404": STD_ERRORS["404"],
        },
      },
      put: {
    ...
    "/api/portal/login": {
      post: {
        ...
        requestBody: body(
          obj({ customerId: str({ format: "uuid" }) }, ["customerId"]),
        ),
        responses: {
          "200": dataResp(
            "JWT token",
            obj({ token: str(), expiresIn: { type: "integer" } }),
          ),
          "401": errorResp("Invalid customerId"),
        },
      },
    },
    "/api/portal/me": {
      get: {
        ...
        responses: {
          "200": dataResp("Customer", ref("Customer")),
    ...
    "/api/portal/quotes": {
      get: {
        tags: ["Portal"],
        summary: "List quotes for the authenticated customer",
        parameters: pageParams,
        responses: {
          "200": dataResp("Array of quotes", {
            type: "array",
  ...
  components: {
    schemas: {
      ...
      WorkflowStatus: obj({
        ...
        canInvoice: { type: "boolean" },
      }),
      ApprovalStep: obj({
        id: str({ format: "uuid" }),
        approvalRequestId: str({ format: "uuid" }),
        stepNumber: { type: "integer" },
        approverUserId: str(),
        status: str({ enum: ["pending", "approved", "rejected"] }),
        notes: str({ nullable: true }),
        decidedAt: str({ format: "date-time", nullable: true }),
      }),
      ApprovalRequest: obj({
        id: str({ format: "uuid" }),
        quoteId: str({ format: "uuid" }),
        ...
        createdAt: str({ format: "date-time" }),
        completedAt: str({ format: "date-time", nullable: true }),
      }),
      ApprovalStatus: obj({
        quote: ref("Quote"),
        ...
        progress: obj({
          ...
          approvalPercentage: { type: "integer" },
        }),
      }),
      Payment: obj({
        id: str({ format: "uuid" }),
      ...
      InvoiceBalance: obj({
        ...
        outstanding: num(),
        status: str({
          enum: ["issued", "sent", "partially_paid", "paid", "cancelled"],
        }),
      }),
